...
if ( file_exists( '/home/winlight-user/www/wp-content/plugins/wp-rocket/inc/vendors/classes/class-rocket-mobile-detect.php' ) && ! class_exists( 'Rocket_Mobile_Detect' ) ) {
	include_once '/home/winlight-user/www/wp-content/plugins/wp-rocket/inc/vendors/classes/class-rocket-mobile-detect.php';
}
...
if ( version_compare( phpversion(), '5.4' ) >= 0 ) {
	...
	spl_autoload_register(
		function( $class ) {
			$rocket_path    = '/home/winlight-user/www/wp-content/plugins/wp-rocket/';
			$rocket_classes = [
	...
	$rocket_config_class = new \WP_Rocket\Buffer\Config(
		[
			'config_dir_path' => '/home/winlight-user/www/wp-content/wp-rocket-config/',
		]
	);
	...
	( new \WP_Rocket\Buffer\Cache(
		...
		$rocket_config_class,
		[
			'cache_dir_path' => '/home/winlight-user/www/wp-content/cache/wp-rocket/',
		]
	) )->maybe_init_process();
} else {
